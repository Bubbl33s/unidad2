...
Es un bucle finito, porque se le indica la cantidad de veces que se
debe repetir.
...
inicio: Valor en el cual inicia el bucle (let i = valor)
...
Iterador: Una variable que va recorriedo un objeto iterable.
*/
...
for (let i = 0; i < 10; i++) {
  console.log(i);
  // En la última línea se actualiza el valor de i
}
